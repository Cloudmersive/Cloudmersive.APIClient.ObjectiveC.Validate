...
#import "CMConfiguration.h"
#import "CMResponseDeserializer.h"
 ...
 */
extern NSString *const CMResponseObjectErrorKey;


@interface CMApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<CMConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<CMResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<CMSanitizer> sanitizer;
 ...
 */
- (instancetype)initWithConfiguration:(id<CMConfiguration>)configuration;
...
* @param configuration The configuration implementation
*/
- (instancetype)initWithBaseURL:(NSURL *)url configuration:(id<CMConfiguration>)configuration;
