...
#ifndef CMDebugLogResponse
#define CMDebugLogResponse(response, responseObject,request, error) [[CMLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef CMDebugLog
#define CMDebugLog(format, ...) [[CMLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by CMConfiguration debug property
 */
