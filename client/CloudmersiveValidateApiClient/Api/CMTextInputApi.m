...
@interface CMTextInputApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMTextInputApi

NSString* kCMTextInputApiErrorDomain = @"CMTextInputApiErrorDomain";
NSInteger kCMTextInputApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) textInputCheckXssWithValue: (NSString*) value
    ...
    if (value == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMTextInputApiErrorDomain code:kCMTextInputApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/text-input/check/xss"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"CMXssProtectionResult*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMXssProtectionResult*)data, error);
                                }
                            }];
}
...
///  @param value User-facing text input. 
///
///  @returns CMXssProtectionBatchResponse*
///
-(NSURLSessionTask*) textInputCheckXssBatchWithValue: (CMXssProtectionBatchRequest*) value
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/text-input/check-and-protect/xss/batch"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMXssProtectionBatchResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMXssProtectionBatchResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) textInputProtectXssWithValue: (NSString*) value
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/text-input/protect/xss"];
