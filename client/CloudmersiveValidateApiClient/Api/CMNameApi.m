...
@implementation CMNameApi

NSString* kCMNameApiErrorDomain = @"CMNameApiErrorDomain";
NSInteger kCMNameApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) nameGetGenderWithInput: (CMGetGenderRequest*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMNameApiErrorDomain code:kCMNameApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/name/get-gender"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"CMGetGenderResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMGetGenderResponse*)data, error);
                                }
                            }];
}
...
///
///  @returns CMFirstNameValidationResponse*
///
-(NSURLSessionTask*) nameValidateFirstNameWithInput: (CMFirstNameValidationRequest*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/name/first"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMFirstNameValidationResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMFirstNameValidationResponse*)data, error);
                                }
                            }];
}
...
///  @param input Validation request information 
///
///  @returns CMFullNameValidationResponse*
///
-(NSURLSessionTask*) nameValidateFullNameWithInput: (CMFullNameValidationRequest*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/name/full-name"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMFullNameValidationResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMFullNameValidationResponse*)data, error);
                                }
                            }];
}
...
///  @param input Validation request information 
///
///  @returns CMLastNameValidationResponse*
///
-(NSURLSessionTask*) nameValidateLastNameWithInput: (CMLastNameValidationRequest*) input
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/validate/name/last"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMLastNameValidationResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMLastNameValidationResponse*)data, error);
                                }
                            }];
}
